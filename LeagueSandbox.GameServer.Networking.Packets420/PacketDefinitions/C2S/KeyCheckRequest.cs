...
{
	[Packet(PacketCmd.KeyCheck, Channel.Handshake)]
	internal class KeyCheckRequest : IRequestPacketDefinition
	{
		...
		public uint ClientID { get; }         //short testVar[8];   //User id
		public uint VersionNo { get; }
		public ulong CheckId { get; }        //short checkVar[8];  //Encrypted testVar
		public uint Trash2 { get; }
