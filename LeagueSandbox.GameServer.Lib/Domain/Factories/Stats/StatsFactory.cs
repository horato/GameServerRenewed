    ...
    internal class StatsFactory : EntityFactoryBase<Entities.Stats.Stats>, IStatsFactory
    {
        ...
        public IStats CreateFromCharacterData(ICharacterData data)
        {
            ...
            (
                ...
                _flatStatFactory.CreateNew(0, data.PhysicalDamagePerLevel, 0, 0),
                _flatStatFactory.CreateNew(0, data.AbilityPowerIncPerLevel, 0, 0),
                _flatStatFactory.CreateNew(0, data.ArmorPerLevel, 0, 0),
                _flatStatFactory.CreateNew(0, data.SpellBlockPerLevel, 0, 0),
                _flatStatFactory.CreateNew(0, data.CritChancePerLevel, 0, 0),
                _flatStatFactory.CreateEmpty(),
                _flatStatFactory.CreateEmpty(),
                _flatStatFactory.CreateEmpty(),
