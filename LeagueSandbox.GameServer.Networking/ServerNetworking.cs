...
{
	public class ServerNetworking : IServerNetworking
	{
		...
		public ServerNetworking(IUnityContainer container)
		{
		...
		{
			if (_isRunning)
				throw new InvalidOperationException("Server is alredy running");
